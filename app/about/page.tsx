    ...
    <>
      ...
      >
        <div className="mt-12 grid gap-10 md:grid-cols-2">
          <div className="rounded-[2rem] border border-white/10 bg-[linear-gradient(135deg,rgba(255,122,0,0.08),rgba(255,255,255,0.02))] p-10 backdrop-blur-xl">
          ...
          <div className="rounded-[2rem] border border-white/10 bg-[linear-gradient(135deg,rgba(59,130,246,0.08),rgba(255,255,255,0.02))] p-10 backdrop-blur-xl">
        ...
        <div className="relative mt-12 max-w-4xl space-y-8 before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-white/10 before:to-transparent">
          {timeline.map((item, index) => (
            <div key={item.year} className={`relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active`}>
              ...
              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-6 rounded-[1.5rem] border border-white/10 bg-white/[0.03] backdrop-blur-xl hover:-translate-y-1 transition-transform">
